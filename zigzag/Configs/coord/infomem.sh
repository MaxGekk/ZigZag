...
../../../tools/infomem.py $MAC_ADDRESS $CHANNELS Z_PAN_ID=243 Z_MAX_CHILDREN=4 Z_MAX_ROUTERS=4 Z_MAX_DEPTH=7 Z_BEACON_ORDER=15 Z_SUPERFRAME_ORDER=15 Z_SCAN_ORDER=6 ALIVE_SEND_PERIOD=20 ALIVE_SEND_ATTEMPTS=3
