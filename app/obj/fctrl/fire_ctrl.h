...
// For certification. Later device type field  should be added into configuration
// But adress ranges will be used to distiquish between device types
#define FIRE_FIRST_ADDR    0x64
#define FIRE_SENSOR_NUM    0x400 - 0x64
#define FBUT_FIRST_ADDR    0x400
#define FBUT_NUM           0x400
#define GERK_FIRST_ADDR    0x1000
#define GERK_SENSOR_NUM    0x400
#define USVD_FIRST_ADDR    0x800
#define USVD_NUM           0x200
#define VIBR_FIRST_ADDR    0x1400
#define VIBR_SENSOR_NUM    0x400
#define ABUT_FIRST_ADDR    0x1800
#define ABUT_NUM           0x400
...
#define SYS_SOUND_OFF      0x00
#define SYS_SOUND_FIRE     0x01
#define SYS_SOUND_ALARM    0x02

#define SOUND_ALARM_PERIOD 0x500
