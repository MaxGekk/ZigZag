...
/* gpio */
volatile uint8_t P1IN asm("0x0020");    /* Port 1 Input */
volatile uint8_t P1OUT asm("0x0021");   /* Port 1 Output */
volatile uint8_t P1DIR asm("0x0022");   /* Port 1 Direction */
volatile uint8_t P1IFG asm("0x0023");   
volatile uint8_t P1IES asm("0x0024");
volatile uint8_t P1IE asm("0x0025");
volatile uint8_t P1SEL asm("0x0026");

volatile uint8_t P2IN asm("0x0028");    /* Port 2 Input */
volatile uint8_t P2OUT asm("0x0029");   /* Port 2 Output */
volatile uint8_t P2DIR asm("0x002A");   /* Port 2 Direction */
...
volatile uint8_t P4IN asm("0x001C");    /* Port 4 Input */
volatile uint8_t P4OUT asm("0x001D");   /* Port 4 Output */
volatile uint8_t P4DIR asm("0x001E");   /* Port 4 Direction */
volatile uint8_t P4SEL asm("0x001F");   /* Port 4 Selection */

volatile uint8_t P5IN asm("0x0030");    /* Port 5 Input */
volatile uint8_t P5OUT asm("0x0031");   /* Port 5 Output */
volatile uint8_t P5DIR asm("0x0032");   /* Port 5 Direction */
volatile uint8_t P5SEL asm("0x0033");   /* Port 5 Selection */


volatile uint8_t P6IN asm("0x0034");    /* Port 5 Input */
volatile uint8_t P6OUT asm("0x0035");   /* Port 5 Output */
volatile uint8_t P6DIR asm("0x0036");   /* Port 5 Direction */
volatile uint8_t P6SEL asm("0x0037");   /* Port 5 Selection */
